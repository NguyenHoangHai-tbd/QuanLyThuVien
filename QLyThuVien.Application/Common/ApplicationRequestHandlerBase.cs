...
public abstract class ApplicationRequestHandlerBase
{
    protected ApplicationRequestHandlerBase(ILibraryRepository repository, ICurrentUserContext currentUser, IClock clock)
    {
